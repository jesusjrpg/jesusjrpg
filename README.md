...
### IT Manager & Unity Developer

I am a results-driven **IT Manager** with a high-growth career path and over **8 years of experience** exploring and building in **Unity**. I specialize in bridging the gap between robust IT infrastructure and creative game engineering.
...
* **IT Management & Leadership:** Team Leadership, Project Management (Agile/ITIL), IT Budgeting & Purchasing, Vendor Management.
* **Infrastructure & Ops:** Systems & Networks (Cisco VLANs), Virtualization, Backup & Recovery Strategy, Device Setup & Maintenance (PC/Mobile).

---

### Featured Projects
* **[Legend of Selda]**: A 2D RPG focused on systems architecture and core gameplay mechanics.
  * [View Code](https://github.com/jesusjrpg/Legend-of-Selda)
* **[Africa's Game]**: A fully functional Android project focused on mobile optimization.
  * [View Code](https://github.com/jesusjrpg/Africas-Game)
---

**How to reach me:** [jesus.parra.garcia@hotmail.com]

*"Software is my profession, Game Dev is my craft."*
